...
(function($) {
    ...
    try {
        $('.menu-button').on("click",function(e) {
            ...
            $('.submenu', menuClassic).each(function(e) {
        ...
        $('.menu-holder ul > li:not(.submenu) > a').on("click",function(e){
        ...
        if(width<991){
            ...
            menuClassicSubmenu.on("click",function(e) {
                var open = false;
                if($(this).hasClass('open')) {
                        open = true;
                }
                menuClassicSubmenu.each(function(e) {
    ...
    /*-------------------------------------------------*/
    try {
        $('.menu-holder .search').on("click",function(e) {
    ...
    try {
        if(width <= 480) {
            ...
            $('#flexslider-nav ul li').each(function(e) {
            ...
            $('#flexslider ul li').each(function(e) {
                var background = $(this).attr('style');
                $(this).attr('style','height:' + height + 'px !important;' + background);
            });
        }
        ...
        $('#flexslider-nav').flexslider({
            ...
            before: function(slider){
                $(slider).find(".flex-animation").each(function(e){
    ...
    /*-------------------------------------------------*/
    try {
        var $masonryContainer = $('section[data-isotope="load-simple"] .model-items');
        $masonryContainer.imagesLoaded( function(e){
    ...
    try {
        ...
        $galleryContainer.imagesLoaded( function(e){
    ...
    try {
        ...
        $blogContainer.imagesLoaded( function(e){
    ...
    $('div[data-responsive="parent-height"]').each(function(e) {
        parentHeightKey.push({id:$(this).attr('data-responsive-id'),height:$(this).outerHeight(true)}); 
    });
    $('div[data-responsive="child-height"]').each(function(e) {
        var childHeight;
    ...
    $('.gallery-button').each(function(e) { 
        $(this).magnificPopup({
            delegate: 'a',
            type: 'image',
            gallery: {
    ...
    /*-------------------------------------------------*/
    try {
        $('#post-wrap').on("click",'#share',function(e) {
    ...
    /*-------------------------------------------------*/
    try {
        $('#flexslider-nav #text').appear(function(e) {
            $('#counters .statistic span').countTo({
                speed: 4000,
                refreshInterval: 60,
                formatter: function (value, options) {
...
$(document).ready(function($) {
    ...
    try {
        $('#skills').appear(function(e) {
            jQuery('.skill-list li span').each(function(e){
                jQuery(this).animate({
                    width:jQuery(this).attr('data-percent')
                },2000);
            });
            $('.skill-list li .count').each(function (e) {
